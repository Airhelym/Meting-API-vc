...
define('APCU_CACHE', false);     // ⚠️ Vercel 不支持 APCu 扩展，必须为 false
define('AUTH', false);
...
$CUSTOM_SERVERS = [
    'lolic' => [
        ...
        'direct_return' => true,
        'timeout'       => 8, // ⚠️ Vercel 免费层默认超时 10s，留 2s 余量
    ]
];
...
switch ($type) {
    case 'playlist':
        ...
        if (CACHE) {
            ...
            $playlist_json = json_encode($playlist, JSON_UNESCAPED_UNICODE); // ✅ 修复原代码未定义变量
